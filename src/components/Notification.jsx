  ...
  return (
    <div
      className={`nav-item absolute right-5 md:right-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96 ${
        isClicked.notification ? "block" : "hidden"
      }`}
    >
      <div className="flex justify-between items-center">
        ...
        <button
          type="button"
          className="text-xl rounded-full p-3 hover:bg-light-gray mt-3 block"
        >
          <MdOutlineCancel />
        </button>
      </div>
          ...
          <button
            className={`text-white text-sm py-2 px-4 rounded-lg ${
              currentColor === "#03C9D7"
                ...
                : "bg-orange-theme hover:bg-orange-theme-hover"
            }`}
            onClick={() => handleClick("notification", false)}
          >
